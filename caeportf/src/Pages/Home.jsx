  ...
  <div className="relative flex flex-col md:flex-row h-[100vh] overflow-hidden items-center pt-[19vh] ">
   ...
   <video className="absolute inset-0 object-cover w-full h-full" muted loop autoPlay>
        ...
        <div className="mt-16 md:mt-0  pr-10 md:pr-0 w-[400px] md:w-[700px] flex flex-col gap-6 h-full">
            ...
            <br/>
              Final Year Physical Science Student passionate about <br/> building innovative web solutions.
               ...
               <Link to = "/projects">
            <button className="h-10 mt-10 ml-20 text-2xl text-white border-2 border-blue-600 md:ml-32 w-60 hover:animate-jump hover:bg-gradient-to-tl from-blue-600 to-yellow-400 via-red-500">View My Work</button>
            </Link>
    ...
    <div className="z-10 flex items-center justify-center order-1 w-1/2 mt-8 md:mt-0 md:order-2 ">
      ...
      <img src="./public/images/p1.jpg" className= "h-[200px] md:h-[300px] ml-6 md:ml-0 w-[200px] md:w-[300px] rounded-full border-4 border-green-500  "  alt="My Profile Photo" /> 
      <Link to="/about">
          <button className=" hover:text-green-500 text-transparent text-white text-[2rem] ml-6 md:ml-20 px-2   ">About me</button>
          </Link>
    </div>
</div>
