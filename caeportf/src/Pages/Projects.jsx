...
export default function Projects() {
  return (    <div className="px-6 pt-40 md:px-20 pb-52 bg-gradient-to-t from-blue-600 to-green-400 via-yellow-300">
      ...
      <p className='projtit'><a href="https://github.com/ChaminduAE/MOSAIC-Blogging-Platform.git"><FaGithub/></a> </p>
      </div>
      </div>
   ...
   <div class="projectcard">
    ...
    <div class="projectcarddown">
      ...
      <p className='projtit'><a href="https://github.com/ChaminduAE/C_A_Eldeniya-Portfolio.git"><FaGithub/></a></p>
    </div>
   </div>
   ...
   <div class="projectcard">
    ...
    <div class="projectcarddown">
      ...
      <p className='projtit'><a href="https://github.com/ChaminduAE/Air-Quality-Index-From-Various-Locations-of-India---My-second-Power-BI-Project.git"><FaGithub/></a></p>
    </div>
   </div>
   ...
   <div class="projectcard">
    ...
    <div class="projectcarddown">
      ...
      <p className='projtit'><a href="https://github.com/ChaminduAE/Road_accident_data_by_vehicle_type_Power-BI-Project.git"><FaGithub/></a></p>
    </div>
   </div>
   ...
   <div class="projectcard">
    ...
    <div class="projectcarddown">
      ...
      <p className='projtit'><a href="https://github.com/ChaminduAE/Identifying-the-Factors-Affecting-Traffic-Jam-in-Kiribathgoda-Area--Statistical-Research-Project-.git"><FaGithub/></a></p>
    </div>
   </div>
